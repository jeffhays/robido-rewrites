...
1. Clone the repository:
    git@github.com:jphase/Ruby-PCAP-Bubble-Chart.git

2. Change directory to Ruby-PCAP-Bubble-Chart
    cd Ruby-PCAP-Bubble-Chart

3. Copy the config/initializers/secret_token.rb.example file to config/intializers/secret_token.rb and edit the contents:
    mv config/initializers/secret_token.rb.example config/initializers/secret_token.rb

4. Edit the secret_token.rb file and place your newly generated secret token in there
    rake secret
    (copy the output of the above command and place it on line 7 of config/initializers/secret_token.rb)

5. Save your changes, navigate to your app's document root, and start the rails server
    rails server

6. Browse to http://localhost:3000 and upload a PCAP file!
